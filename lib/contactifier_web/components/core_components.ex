defmodule ContactifierWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ContactifierWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ContactifierWeb.Gettext, "errors", msg, opts)
    end
  end
