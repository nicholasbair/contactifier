defmodule ContactifierWeb.CustomerLive.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <.simple_form
        ...
        phx-submit="save"
      >
        <.input field={@form[:arr]} type="number" label="Arr" step="any" />
        <.input field={@form[:domain]} type="text" label="Domain" />
        <.input field={@form[:name]} type="text" label="Name" />
        <.input field={@form[:use_case]} type="text" label="Use case" />
        <:actions>
